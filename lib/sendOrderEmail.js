...
const getTransporter = () => {
  // Use port 587 + STARTTLS — port 465 (SSL) is blocked by Render hosting
 ...
 * @param {{ email: string, firstName: string, lastName: string }} customer
...
<div style="font-family: Arial, sans-serif; background-color: #f4f4f5; padding: 40px; text-align: center;" dir="ltr">
  <div style="max-width: 500px; margin: 0 auto; background-color: #ffffff; border-radius: 16px; padding: 40px; box-shadow: 0 4px 6px rgba(0,0,0,0.05);">
    ...
    console.error("sendOrderConfirmedEmail error:", err);
  }
};

/**
 * Send a rejection/cancellation email to the customer.
 * @param {{ email: string, firstName: string, lastName: string }} customer
 * @param {string} orderNumber
 */
...
<div style="font-family: Arial, sans-serif; background-color: #f4f4f5; padding: 40px; text-align: center;" dir="ltr">
  <div style="max-width: 500px; margin: 0 auto; background-color: #ffffff; border-radius: 16px; padding: 40px; box-shadow: 0 4px 6px rgba(0,0,0,0.05);">
    ...
    console.error("sendOrderRejectedEmail error:", err);
  }
};
